...
#+begin_src haskell-ng :results output
fmap (runParser tokens) (C.lines exPage1)
#+end_src

#+RESULTS:
: [OK [] "",OK [GlyphToken ArrayLeft,IntToken 1,IntToken 5,IntToken 8,IntToken 2,GlyphToken ArrayRight] "",OK [GlyphToken Reduce,GlyphToken Add,GlyphToken Duplicate,CommentToken " Sum"] "",OK [GlyphToken Length,GlyphToken Flip,CommentToken " Length"] "",OK [GlyphToken Divide,CommentToken " Divide"] ""]

#+begin_src haskell-ng :results output
fmap (runParser tokens) (C.lines exPage2)
#+end_src

#+RESULTS:
: [OK [] "",OK [IntToken 2,GlyphToken Strand,IntToken 3,GlyphToken Strand,IntToken 4] "",OK [GlyphToken Reduce,GlyphToken Multiply,GlyphToken Duplicate,CommentToken " Product"] "",OK [GlyphToken Range,CommentToken " Range"] "",OK [GlyphToken Reshape,GlyphToken Flip,CommentToken " Reshape"] ""]

#+begin_src haskell-ng :results output
fmap (runParser tokens) (C.lines exPage3)
#+end_src

#+RESULTS:
: [OK [] "",OK [StringToken "Unabashedly I utilize arrays"] "",OK [GlyphToken NotEquals,CharacterToken ' ',GlyphToken Duplicate,CommentToken " Mask of non-spaces"] "",OK [GlyphToken Partition,GlyphToken First,CommentToken " All first letters"] ""]
