...
glyphP =
  (Duplicate <$ string ".")
    ...
    CP.<|> (NotEquals <$ string "≠")
    CP.<|> (LessThan <$ string "<")
    CP.<|> (LessOrEqual <$ string "≤")
    CP.<|> (GreaterThan <$ string ">")
    CP.<|> (GreaterOrEqual <$ string "≥")
    CP.<|> (Add <$ string "+")
    CP.<|> (Subtract <$ string "-")
    CP.<|> (Multiply <$ string "×")
    CP.<|> (Divide <$ string "÷")
    ...
    CP.<|> (Partition <$ string "⊜")
    CP.<|> (Un <$ string "°")
    CP.<|> (Setinv <$ string "setinv")
    CP.<|> (Setund <$ string "setund")
    CP.<|> (Under <$ string "⍘")
    CP.<|> (Content <$ string "◇")
    CP.<|> (Fill <$ string "⬚")
    CP.<|> (Parse <$ string "⋸")
    ...
    CP.<|> (Strand <$ string "_")
    CP.<|> (ArrayLeft <$ string "[")
    CP.<|> (ArrayRight <$ string "]")
    CP.<|> (BoxArrayLeft <$ string "{")
    CP.<|> (BoxArrayRight <$ string "}")
    CP.<|> (FunctionLeft <$ string "(")
    CP.<|> (FunctionRight <$ string ")")
    CP.<|> (SwitchLeft <$ string "⟨")
    CP.<|> (SwitchRight <$ string "⟩")
    CP.<|> (Character <$ string "@")
    CP.<|> (Format <$ string "$")
    CP.<|> (String <$ string "\"")
    CP.<|> (Macro <$ string "!")
    CP.<|> (Placeholder <$ string "^")
    CP.<|> (Binding <$ string "←")
    CP.<|> (PrivateBinding <$ string "↚")
    CP.<|> (Import' <$ string "~")
    CP.<|> (Signature <$ string "|")
    CP.<|> (Comment <$ string "#")
